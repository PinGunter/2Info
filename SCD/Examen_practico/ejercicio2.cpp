...
const int num_lector = 3;
const int num_escri = 4;
...
private:
   ...
   bool pareja_escritores;   //variable para controlar las parejas
                             // true indica que va a entrar una pareja, el primero de esta
                             // false  indica que entra el segundo escritor de la pareja y por tanto los proximos deben entrar en pareja
public:
   Lec_Esc();
   void ini_lectura();
   void fin_lectura();
