...
*/
 ...
 /*************   MÉTODOS NUEVOS ****************\*/
  ...
  /**
   * @brief funcion que reduce un numero racional
   * @pre el objeto de la clase racional debe estar inicializado a valores válidos antes de ser reducido
   * @post el objeto de la clase que lo llama queda reducido, cumpliendo los valores válidos
   */
  void reducir();

  /**
   * @brief método que obtiene el valor real de un numero racional
   * @pre el objeto racional que lo llama debe estar inicializado a valores válidos
...
/**
 * @brief función que calcula el máximo comun divisor de dos números basado en el algo. de Euclides
 * @param primero el primero de la pareja de números sobre la que se calcula
 * @param segundo el segundo de la pareja de números sobre la que se calcula
 * @return el MCD de ambos números
 */
