...
suma:
	...
	mov  $0, %rdx #indice a 0
bucle:
	add  (%rbx,%rdx,4), %eax  ## acumula i-esimo elemento. redireccionamiento indirecto, rbx dir. base + 4* indice. Indice = rdx
	inc   %rdx 	#incrementa indice
	cmp   %rdx,%rcx	#compara longitud
	jne    bucle
